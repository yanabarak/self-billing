jQuery(document).ready(function ($) {
  ...
  //       e.preventDefault();
  //       let toast = $(e.target).attr('data-toast-id');
  //       toast = $(`#${toast}`);
  //       $(toast).css({ left: 'auto', right: 'auto', top: 'auto', bottom: 'auto' });
  //       $(toast).find('.toast-body').html($(e.target).attr('data-toast-value'));
  ...
  //       // Get the position of the clicked link, width of the link, and the width of the toast
  //       const linkLeft = $(this).offset().left;
  //       const linkWidth = $(this).outerWidth();
  //       const toastWidth = $(toast).outerWidth();

  //       // Get the available space at the left and right of the clicked link
  //       const spaceLeft = linkLeft - $(window).scrollLeft();
  //       const spaceRight = $(window).width() - spaceLeft - linkWidth;

  //       // Calculate the maximum allowed space at the left and right for the toast
  //       const maxSpaceLeft = 100; // Adjust this value as needed
  //       const maxSpaceRight = 100; // Adjust this value as needed
  //       const linkTop = $(this).offset().top;
  //       const toastHeight = $(toast).outerHeight();

  //       // Get the available space at the top and bottom of the clicked link
  //       const spaceTop = linkTop - $(window).scrollTop();
  //       const spaceBottom = $(window).height() - spaceTop - $(this).outerHeight();

  //       // Calculate the maximum allowed space at the top for the toast
  //       const maxSpaceTop = 100; // Adjust this value as needed

  //       // Show the toast at the left if there is enough space, otherwise show it at the right
  //       if (spaceLeft >= toastWidth + maxSpaceLeft) {
  //         $(toast).css({
  //           left: linkLeft - toastWidth - 10 + 'px', // Adjust the '10' value for spacing
  //           right: 'auto',
  //         });
  //       } else if (spaceRight >= toastWidth + maxSpaceRight) {
  //         $(toast).css({
  //           left: linkLeft + linkWidth + 10 + 'px', // Adjust the '10' value for spacing
  //           right: 'auto',
  //         });
  //       }
  //       $(toast).css({
  //         top: linkTop - toastHeight - 10 + 'px', // Adjust the '10' value for spacing
  //         bottom: 'auto',
  //       });

  //       // Now, apply the top/bottom positioning logic (as in the previous answer)
  //       // ...
  ...
  function showInfo() {
    $('.show-info').click(function (e) {
      ...
      //   linkViewportOffsetTop = offset.top - $(document).scrollTop();
      //   console.log(window.innerHeight - linkViewportOffsetTop);

      //   let bottom = window.innerHeight;
      //   //   console.log(window.innerHeight, linkViewportOffsetTop);
      //   if (window.innerHeight - linkViewportOffsetTop < 100) {
      //     $(toast).attr(
      //       'style',
      //       `bottom:${window.innerHeight - linkViewportOffsetTop - 200}px !important;`
      //     );
      //   } else {
      //     $(toast).attr(
      //       'style',
      ...
      //   }
      //   if (
      //     $(e.target).closest('body')[0].getBoundingClientRect().right -
      //       e.target.getBoundingClientRect().left <=
      //     360
      //   ) {
      //     let right =
      //       $(e.target).closest('body')[0].getBoundingClientRect().right -
      //       e.target.getBoundingClientRect().left;
      //     $(toast).css('right', `${right}px`);
      //     $(toast).addClass('right-0');
      //   } else {
      //     $(toast).css('left', `${left - 60}px`);
      //   }
      //   $(toast).removeClass('start-0');
